...
import com.jibo.base.src.request.impl.soap.AsyncResponseHandler;
 ...
 * @author peter.pan
 */
public class AsyncSoapResponseHandler extends AsyncResponseHandler{
    private static final int SUCCESS_MESSAGE = 0;
    private static final int FAILURE_MESSAGE = 1;
    private static final int START_MESSAGE = 2;
    private static final int FINISH_MESSAGE = 3;
	private static final int RELOAD_MESSAGE = 4;
        ...
        if(Looper.myLooper() != null) {
            handler = new Handler(){
                public void handleMessage(Message msg){
                    AsyncSoapResponseHandler.this.handleMessage(msg);
                }
            };
        }
    }
    ...
    protected void handleSuccessMessage(SoapDataPaser responseBody,int methodId) {
     ...
     */
    void sendResponseMessage(int methodId ,SoapSerializationEnvelope response) throws Exception{
   
    	Object o =SoapPaserFactory.paserData(methodId, response);
        if(o==null) {
    ...
    public void sendReloadMessage(String responseBody) {
        sendMessage(obtainMessage(RELOAD_MESSAGE, new Object[]{null, responseBody}));
    }
}