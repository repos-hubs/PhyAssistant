...
public class FileCategoryHelper {
    ...
    public static final Map<FileCategory,Drawable> bg = new HashMap<FileCategory,Drawable>();
    //×¢²áÄ¬ÈÏÍ¼Æ¬
    public static void initDefaultPic(Context ctx){
    	bg.put(FileCategory.Picture, FileInfo.iconImageLoading);
    }
    public enum FileCategory {

        All, Music, Video, Picture, Theme, Doc, Zip, Apk, Custom, NoType, Favorite, NoRecorded,Folder,Net
    }
    ...
    public static FileTypeInfo getCategoryFromPath(Object path) {
        ...
        int dotPosition = path == null ? -1 : path.toString().lastIndexOf('.');
        if (dotPosition > -1) {
        ...
        return MimeUtil.isTypeFromMime(path.toString(), FileTypeInfo.typeInfos);
    }
}
