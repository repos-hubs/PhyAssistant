...
public class FileInfo {
	...
	public static final int IMAGE_LOADING_ICON = com.api.android.GBApp.R.drawable.boutus_normal;
	...
	public final static int DIR_RES = -1;
	public final static int OTHER_FILE_RES = -1;
	...
	public static void init(Context context) {
		...
		if (iconImageLoading == null) {
			iconImageLoading = context.getResources().getDrawable(
					IMAGE_LOADING_ICON);
		}
		if (iconVideo == null) {
