...
//		TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.FlipViewController, 0, 0);
		...
		try {
//			int value = a.getInteger(R.styleable.FlipViewController_direction, HORIZONTAL);
//			if (value == HORIZONTAL)
...
//			a.recycle();
	...
	public View getViewByPosition(int position) {
		return (position < bufferedViews.size() && position >= 0) ? bufferedViews.get(position) : null;
	}
